...
public class VehApp extends AbstractApplication<VehicleOperatingSystem>
    ...
    private void sendMessageToRSU() {
        ...
        VehInfoMsg message = new VehInfoMsg(routing, time, getOs().getId(), new Position(getOs().getPosition()),
                this.vehHeading,
    ...
    private void sendVehInfoMsg() {
        ...
        VehInfoMsg message = new VehInfoMsg(routing, time, getOs().getId(), getOs().getPosition(), this.vehHeading,
                this.vehSpeed, this.vehLane);
        getOs().getAdHocModule().sendV2xMessage(message);
