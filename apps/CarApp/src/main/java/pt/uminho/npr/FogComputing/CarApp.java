package pt.uminho.npr.FogComputing;
...
public class CarApp extends AbstractApplication<VehicleOperatingSystem> implements VehicleApplication, CommunicationApplication
{
    ...
    // Send a STOP message every 5 seconds
